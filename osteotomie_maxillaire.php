...
<html>
	<head>
		<title>Ostéotomie maxillaire de Le Fort I - La chirurgie orthognatique</title>
		<?php include("head.php") ?>
		<meta name="description" content="L'ostéotomie maxillaire est souvent réalisée lorsqu'il existe une mâchoire avancée. Vous trouverez ici la
				...
				<div id="content-wrapper">
                    ...
                    <section class="non_imprime">
                      ...
                      <p>
                        ...
                        science pour réaliser une <strong>ostéotomie maxillaire</strong> de Le Fort, le risque de complication n’est pas nul.<br />
                        ...
                        <ul class="basic-list">
                          ...
                          <li>Complications nerveuses :<br />
                            En post-opératoire immédiat, une perte de la sensibilité totale (anesthésie) ou partielle (hypoesthésie) labio-jugale est
                            classique. A ce stade, ce n’est pas une complication. Ces troubles de la sensibilité sont temporaires et récupèrent en
                            quelques semaines dans la grande majorité des cas. La persistance exceptionnelle de ces troubles est une complication.
                          </li>
                          ...
                          <li>Complications osseuses :<br />
                            L’absence de consolidation osseuse (pseudarthrose) est très exceptionnelle au niveau du maxillaire. Elle nécessite une
                            ...
                            <ul class="level2_list">
                              ...
                              <li>paralysie musculaire</li>
											...
											<div id="liens_telechargement">
												...
												<a href="pdf/osteotomie_maxillaire.pdf" class="button-big" class="right">Télécharger</a>
											</div>
										</section>
								...
								<div class="3u 12u(mobile)">
									...
									<!-- Sidebar -->
										<section class="imagerie">
											<header>
												<h2>L'ostéotomie maxillaire de Le Fort I</h2>
											</header>
                      ...
                      <img src="images/articulateur.png" alt="moulages montés sur un articulateur pour préparer la gouttière qui servira à la réalisation de
											l'ostéotomie maxillaire" width=100% class="zoom" />
											<h3>Comparatifs avant et après ostéotomie maxillaire</h3>
											<img src="images/retromaxillie_avant_apres.png" alt="patiente avant et après ostéotomie maxillaire" width=100% class="zoom" />
											<p>Patiente présentant une rétromaxillie (mâchoire du haut trop courte) et/ou une promandibulie (mâchoire avancée du bas) soit une classe III.<br />
											A gauche, on la voit après l'<strong>ostéotomie maxillaire</strong> et à droite, avant.</p>
											<img src="images/exces_vertical_avant_apres.png" alt="autre patiente avant et après ostéotomie maxillaire" width=100% class="zoom" />
