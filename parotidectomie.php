...
<html>
	<head>
		<title>Parotidectomie - La chirurgie des glandes salivaires</title>
		<?php include("head.php") ?>
		<meta name="description" content="La parotidectomie est l'ablation d'une glande salivaire principale, la parotide. Elle est effectuée le plus souvent pour
		retire une tumeur (en majorité bénigne) ou suite à une parotidite répétée, liée à un calcul. Vous trouverez ici la fiche intervention concernant la
		parotidectomie. L'ADOMF est joignable au 04.42.33.50.97 ou à l'hôpital d'Aix-en-Provence, avenue des Tamaris 13616 Aix-en-Provence.">
	</head>
	<body class="subpage">
		<div id="page-wrapper">
				...
				<div id="content-wrapper">
                    ...
                    <section class="non_imprime">
                      ...
                      <p>
                        ...
                        s’agit d’une tumeur dont il est indispensable de préciser la nature bénigne ou maligne (dans environ 70% des cas, il s’agit de
                        tumeur bénigne). La <strong>parotidectomie</strong>, associée à un examen histologique (microscopique), est à la fois le moyen d’établir le
                        diagnostic de façon certaine et dans le même temps de réaliser le traitement. Beaucoup plus rarement, la pathologie est
                        d’origine lithiasique (calcul) ou inflammatoire (parotidite).
                      </p>
                      ...
                      <p>
                        ...
                        <ul class="basic-list">
                          <li>tumeur bénigne : le geste est déjà complet, la <strong>parotidectomie</strong> reste partielle</li>
                          <li>tumeur mixte (ou adénome pléomorphe) : cette tumeur bénigne est la plus fréquente de la glande parotide. Elle présente
                            un risque de récidive et de cancérisation rare mais possible. La <strong>parotidectomie</strong> est complétée pour être quasi totale</li>
                          <li>tumeur maligne : la <strong>parotidectomie</strong> sera totale, complétée par un curage ganglionnaire cervical (traitement des ganglions
                            du cou) grâce à un prolongement de l'incision dans le cou</li>
                        </ul>
                        En fin d’intervention, un drain peut être mis en place pour évacuer l’hématome post-opératoire.
                      </p>
                      ...
                      <p>
                        ...
                        <ul class="basic-list">
                          ...
                          <li>une parésie (paralysie incomplète) de l’hémiface du côté opéré. Son intensité est variable. Elle est temporaire. La
                            ...
                            kinésithérapie seront  prescrites associées à une protection oculaire nocturne (le déficit de fermeture de l’oeil expose la
                      ...
                      <p>
                        ...
                        <ul class="basic-list">
                          ...
                          <li>le syndrome de Frey : ce phénomène apparaît quelques mois après l’intervention. Il s’agit d’un défaut de cicatrisation de
                            certaines terminaisons nerveuses. Lors de l'alimentation, une hypersudation apparaît sur la joue, d'intensité variable,
                            parfois gênante. Ce syndrome peut être désormais résolu par des injections de toxine botulique</li>
                          <li>la paralysie faciale définitive est exceptionnelle. Elle peut être volontaire par sacrifice délibéré du nerf (tumeur
                            maligne) ou survenir lors d’une chirurgie techniquement complexe (tumeur inflammatoire ou infectée, seconde intervention). Les
														injections de toxine botulique peuvent aider à resymétrisation partielle du visage au repos</li>
												</ul>
											</p>
