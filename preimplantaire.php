			...
			<!-- Content -->
				<div id="content-wrapper">
                    ...
                    <section class="non_imprime">
                        ...
                        synthétique (hydroxyapatites, phosphates tricalciques).<br />
                      ...
                      <p>
                        ...
                        <ul class="basic-list">
                          ...
                          <li>l'élévation sinusienne ou sinus lift : quand il faut remplacer les molaires du haut, un manque d’os en hauteur peut
                            ...
                            En cas de déficit osseux intermédiaire, une méthode sans fraisage est possible : la méthode de Summers. Lors du forage des
                            implants, le substitut osseux est poussé au fond du sinus. Cette technique nécessite une hauteur osseuse minimale de 5
                      ...
                      <p>
                        ...
                        <ul class="basic-list">
                          ...
                          <li>un léger œdème les premiers jours</li>
                      ...
                      <p>
                        ...
                        <ul class="basic-list">
                          ...
                          <li>un hématome et/ou saignement persistant, saignement par le nez</li>
                          <li>une cellulite : inflammation ou infection des tissus mous de la face ou de la bouche</li>
                          <li>une sinusite maxillaire</li>
