...
<html>
	<head>
		<title>Ectropion et entropion - La chirurgie orbito-palpébrale</title>
		<?php include("head.php") ?>
		<meta name="description" content="La chirurgie orbito-palpébrale est la chirurgie du regard et des paupières. Les cures d'ectropion et
		d'entropion en font partie intégrante. Vous trouverez ici la fiche intervention concernant l'ectropion et
		l'entropion. L'ADOMF est joignable au 04.42.33.50.97 ou à l'hôpital d'Aix-en-Provence, avenue des Tamaris 13616 Aix-en-Provence.">
	</head>
	<body class="subpage">
		<div id="page-wrapper">
				...
				<div id="content-wrapper">
                    ...
                    <section class="non_imprime">
                      <p>
                        ...
                        Dans l'<strong>entropion</strong>, ce bord libre se retourne vers l'œil et les cils peuvent venir frotter la cornée.<br />
                        Dans l'<strong>ectropion</strong>, c'est le phénomène inverse : le bord de la paupière s'éverse vers l'extérieur et perd contact avec le globe
                      ...
                      <p>
                        Elle va déterminer l’origine de votre <strong>entropion</strong>/<strong>ectropion</strong> (congénital, sénile, spasmodique, cicatriciel, paralytique).<br />
                      ...
                      <p>
                        ...
                        morceau de paupière sur toute son épaisseur.<br />
												En cas d'<strong>ectropion</strong> isolé du point lacrymal, on pourra essayer de le repositionner en ne retirant qu'une partie de la conjonctive et du
												tarse sous-jacent qui se trouve sur la face interne de la paupière.<br />
												En cas d'<strong>ectropion</strong> cicatriciel, une greffe de peau sera nécessaire. Une greffe conjonctivale sera réalisée dans le cas d'un <strong>entropion</strong>
												cicatriciel.
                      </p>
                      ...
                      <p>
                        ...
                        <ul class="basic-list">
                          <li>l'hématome</li>
                          <li>l'ulcère de cornée</li>
                          <li>l'infection</li>
                          <li>une correction insuffisante causant une récidive de la malposition</li>
                          <li>une correction excessive causant une asymétrie</li>
												</ul>
											</p>
								...
								<div class="3u 12u(mobile)">
									...
									<!-- Sidebar -->
										<section class="imagerie">
											...
											<img src="images/ectropion.png" alt="photo d'un ectropion bilatéral" width=100% class="zoom" />
                      ...
                      <header>
                        <h2>L'entropion</h2>
											...
											<h3>Comparatifs avant et après cure d'entropion</h3>
