                      ...
                      <p>
                        ...
                        <ul class="basic-list">
                          ...
                          <li>Complication infectieuse (cellulite) :
														<ul class="level2_list">
	                            <li>Elle peut survenir quelques jours à quelques semaines après la résection apicale. Un traitement antibiotique associé ou non à un geste sous anesthésie locale
                          ...
                          <li>Récidive du kyste :
														<ul class="level2_list">
	                            <li>L'infection dentaire persiste malgré l'ablation du kyste et justifie alors l'extraction de la dent.</li>
														</ul>
                          </li>
                          <li>Complications sinusiennes :
	                            ...
	                            La résection apicale peut provoquer une sinusite maxillaire.</li>
														</ul>
                          </li>
